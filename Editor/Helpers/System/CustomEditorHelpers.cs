...
namespace com.Klazapp.IndoorMap.Editor
{
    public static partial class CustomEditorHelpers
    {
        ...
        public static Vector3 GetFloat3AsVector(this SerializedProperty property)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetFloat3FromVector(this SerializedProperty property, Vector3 value)
        {
            var p = property.Copy();
            p.Next(true);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector4 GetQuaternionAsVector(this SerializedProperty property)
        {
            var p = property.Copy();
